    ...
    <div>
        ...
        <div v-if="model.is_paid" class="relative mb-4 md:mb-6">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="flex justify-center p-3 mb-2">
                            <div class="w-full h-3 text-center border-b-3 border-teal-dark">
                                <a :href="'/aktivnyj-otdyh/' + model.slug" target="_blank" class="inline text-xl text-teal-dark px-2 bg-white font-bold">
                                    {{ model.name }}
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="relative flex flex-col md:flex-row">
                            <!-- List item image -->
                            <a :href="'/aktivnyj-otdyh/' + model.slug" target="_blank" class="block md:self-end md:w-2/5">
                            ...
                            <div class="pt-3 px-4 pb-1 md:w-3/5 md:flex md:flex-wrap md:relative">
                                ...
                                <div class="flex items-center border-teal-dark py-2 md:w-5/6 md:border-b-0 md:border-dotted md:border-teal-dark md:items-start">
                                    <div class="w-8 h-8 flex-no-shrink mr-3">
                                    ...
                                    <div class="flex-1 break-words min-w-0 flex items-center md:relative">
                                        ...
                                        <div class="self-end md:hidden">
                                            <a :href="`/aktivnyj-otdyh/${model.slug}` + (showCategory ? '?search=1' : '')" target="_blank" class="block text-sm text-white font-bold bg-teal-dark rounded px-4 py-2">Подробнее</a>
                                        </div>
                                    </div>
                                </div>

                                <div class="hidden md:block md:absolute md:pin-b md:pin-r">
                                    <a :href="`/aktivnyj-otdyh/${model.slug}` + (showCategory ? '?search=1' : '')" target="_blank" class="block text-base text-white font-bold bg-teal-dark rounded-tl-lg rounded-br-2xl px-4 py-1">Подробнее</a>
                                </div>
                            </div>

                            <div class="absolute pin-r pin-t mt-8 flex flex-col">
                                <div class="mb-2 flex justify-end md:hidden" v-if="hasActivitiesAt('summer')" @click="selectedSeason = 'summer'" :class="{ 'md:hidden': selectedSeason == 'summer' }">
                                ...
                                <div class="mb-2 flex justify-end md:hidden" v-if="hasActivitiesAt('spring')" @click="selectedSeason = 'spring'" :class="{ 'md:hidden': selectedSeason == 'spring' }">
                                ...
                                <div class="mb-2 flex justify-end md:hidden" v-if="hasActivitiesAt('autumn')" @click="selectedSeason = 'autumn'" :class="{ 'md:hidden': selectedSeason == 'autumn' }">
            ...
            <div class="hidden md:absolute md:pin-r md:pin-t mt-8 md:flex md:flex-col md:mr-2 md:mt-10">
                <div class="mb-3 flex justify-start md:mb-2" v-if="hasActivitiesAt('summer')" @click="selectedSeason = 'summer'">
                ...
                <div class="mb-3 flex justify-start md:mb-2" v-if="hasActivitiesAt('spring')" @click="selectedSeason = 'spring'">
                ...
                <div class="mb-3 flex justify-start md:mb-2" v-if="hasActivitiesAt('autumn')" @click="selectedSeason = 'autumn'">
        ...
        <div v-else class="relative mb-4">
            <div class="flex flex-col rounded-2xl md:mr-20 md:border-2 md:border-white md:border-dashed lg:flex-row">
                ...
                <div class="relative bg-white rounded-2xl flex-1" :class="{ 'rounded-t-none lg:rounded-tr-2xl lg:rounded-l-none': showCategory }">
                    ...
                    <div class="absolute pin-r pin-center mt-10 flex flex-col md:mr-1">
                        <div class="mb-2 flex justify-end md:mb-1" v-if="hasActivitiesAt('summer')" @click="selectedSeason = 'summer'" :class="{ 'md:hidden': selectedSeason == 'summer' }">
                        ...
                        <div class="mb-2 flex justify-end md:mb-1" v-if="hasActivitiesAt('autumn')" @click="selectedSeason = 'autumn'" :class="{ 'md:hidden': selectedSeason == 'autumn' }">
