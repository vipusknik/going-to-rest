<template>
    <div>
        ...
        <div v-if="model.is_paid" class="relative mb-4 md:mb-6">
            <div class="bg-white rounded-lg md:mr-20 md:rounded-2xl lg:border-2 lg:border-dashed">
                <!-- List item name -->
            ...
            <div class="hidden md:absolute md:pin-r md:pin-t mt-8 md:flex md:flex-col md:mr-4">
                <div class="mb-3 flex justify-start" v-if="hasActivitiesAt('summer')" @click="selectedSeason = 'summer'">
                ...
                <div class="mb-3 flex justify-start" v-if="hasActivitiesAt('spring')" @click="selectedSeason = 'spring'">
                ...
                <div class="mb-3 flex justify-start" v-if="hasActivitiesAt('autumn')" @click="selectedSeason = 'autumn'">
        ...
        <div v-else class="relative mb-4">
            <div class="relative bg-white rounded-lg md:mr-20 lg:border-2 lg:border-dashed">
                <!-- List item name -->
                <div class="flex justify-center p-3 mb-2">
                    <div class="w-full h-3 text-center border-b-3 border-teal-dark">
                        <h3 class="inline text-xl text-teal-dark px-2 bg-white font-bold">
