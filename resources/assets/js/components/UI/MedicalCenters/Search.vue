<template>
    <div>
        <div v-if="! showSearchDropdown" class="flex space-between items-center py-3 px-4">
            ...
            <div class="flex-1 text-center text-2xl italic">Медицинский туризм</div>
        ...
        <portal to="sm-md-medical-centers-search-filters">
            <div v-if="showSearchDropdown" class="absolute bg-yellow-dark w-full px-10 py-10 pb-4 sm:z-10 sm:flex sm:flex-wrap sm:py-6 lg:hidden">
                ...
                <div class="sm:w-full flex justify-end">
                    <button @click="showSearchDropdown = false" class="text-lg text-white font-bold tracking-wide bg-teal-dark px-4 rounded-lg w-1/2 h-8">
                        Поиск
                    </button>
                </div>
            </div>
