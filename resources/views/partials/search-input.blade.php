...
<form action="/search" method="GET" class="flex items-center h-10 mb-8 px-2 lg:px-0">
    <input type="text" name="q" value="{{ request()->q }}" id="search-page-search-input" placeholder="Введите название места отдыха" class="block flex-1 h-full text-lg py-2 px-4 rounded-l-xl">
